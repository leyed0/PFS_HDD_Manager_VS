...
{
	BTN_OK->Enabled = !String::IsNullOrEmpty(TXTBX_Input->Text->Trim());
	return System::Void();
}
...
System::Windows::Forms::DialogResult PFSHDDManager::InputBox::Show(String^ text, String^ defaulttxt)
{
	...
	this->TXTBX_Input->Text = defaulttxt;
